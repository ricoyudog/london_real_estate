...
- There is no host-side date/period clarification gate. An unqualified request
  uses the latest canonical view; the returned artifact still carries its
  authoritative `as_of` and freshness metadata.
